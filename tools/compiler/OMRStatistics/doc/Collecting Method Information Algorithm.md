...
for each hierarchy:
  for each subHierarchy in hierarchy:
    trackersMap = new map #map that contains all methodTrackers for this subHierarchy; it links each
    #methodName to all its trackers; format: methodName --> list of MethodTrackers
