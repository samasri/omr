...
| enableAESInHardwareTransformations() | J9::J9::X86 | 1 |
...
| suppressInliningOfRecognizedMethod(TR::RecognizedMethod) | OMR::J9::X86 | 1 |
| nodeMayCauseException(TR::Node *) | OMR::OMR::Z | 0 |
| createStackAtlas() | OMR::J9 | 1 |
...
| needRelocationsForStatics() | OMR::J9 | 1 |
...
| propagateSignThroughBCDLeftShift(TR::DataType) | OMR::J9::Z | 1 |
| alwaysGeneratesAKnownPositiveCleanSign(TR::Node *) | J9::J9::Z | 1 |
...
| jitAddUnresolvedAddressMaterializationToPatchOnClassRedefinition(void *) | OMR::J9 | 1 |
...
| needClassAndMethodPointerRelocations() | OMR::J9 | 1 |
| inlineDirectCall(TR::Node *,TR::Register *&) | OMR::J9::Power | 1 |
| createHWPRecords() | OMR::J9 | 1 |
| isBranchInstruction(TR::Instruction *) | OMR::OMR::X86 | 0 |
| doInstructionSelection() | OMR::OMR::Z | 1 |
...
| allowSplitWarmAndColdBlocks() | OMR::J9::Z | 1 |
| registerAssumptions() | OMR::J9 | 1 |
...
| nopsAlsoProcessedByRelocations() | OMR::X86::J9::X86 | 1 |
| setNextAvailableBlockIndex(int32_t) | OMR::OMR::Power | 0 |
| lowerTreesPreTreeTopVisit(TR::TreeTop *,vcount_t) | OMR::J9 | 1 |
| lowerTreeIfNeeded(TR::Node *,int32_t,TR::Node *,TR::TreeTop *) | OMR::OMR::Z | 1 |
| processRelocations() | OMR::J9 | 1 |
...
| wantToPatchClassPointer(const class TR_OpaqueClassBlock *,const uint8_t *) | OMR::J9 | 1 |
...
| lowerTreesPostChildrenVisit(TR::Node *,TR::TreeTop *,vcount_t) | OMR::J9::X86::i386 | 1 |
| endInternalControlFlow(TR::Instruction *) | OMR::OMR::Z | 0 |
| generateBinaryEncodingPrologue(struct TR_PPCBinaryEncodingData *) | OMR::Power::J9::Power | 1 |
...
| mustGenerateSwitchToInterpreterPrePrologue() | OMR::J9 | 1 |
| dumpTargetAddressSnippets(TR::FILE *) | OMR::OMR::Z | 0 |
| considerTypeForGRA(TR::SymbolReference *) | OMR::OMR::Z | 0 |
| jitAdd32BitPicToPatchOnClassUnload(void *,void *) | OMR::J9 | 1 |
...
| allowGuardMerging() | OMR::X86::J9::X86 | 1 |
...
| wantToPatchClassPointer(const class TR_OpaqueClassBlock *,const TR::Node *) | OMR::J9 | 1 |
| materializesLargeConstants() | OMR::OMR::Power | 0 |
| addProjectSpecializedRelocation(uint8_t *,uint8_t *,uint8_t *,TR_ExternalRelocationTargetKind,char *,uintptr_t,TR::Node *) | OMR::J9 | 1 |
| jitAddPicToPatchOnClassRedefinition(void *,void *,_Bool) | OMR::J9 | 1 |
| internalPointerSupportImplemented() | OMR::OMR::X86 | 0 |
| generateCatchBlockBBStartPrologue(TR::Node *,TR::Instruction *) | OMR::J9 | 1 |
...
| lowerTreesPreChildrenVisit(TR::Node *,TR::TreeTop *,vcount_t) | OMR::J9 | 1 |
| getCurrentBlockIndex() | OMR::OMR::Power | 0 |
| jitAdd32BitPicToPatchOnClassRedefinition(void *,void *,_Bool) | OMR::J9 | 1 |
...
| supportsMethodEntryPadding() | OMR::J9 | 1 |
...
| addProjectSpecializedRelocation(TR::Instruction *,uint8_t *,uint8_t *,TR_ExternalRelocationTargetKind,char *,uintptr_t,TR::Node *) | OMR::J9 | 1 |
...
| setUpForInstructionSelection() | OMR::J9 | 1 |
| dumpDataSnippets(TR::FILE *) | OMR::OMR::X86 | 0 |
| lowerTree(TR::Node *,TR::TreeTop *) | OMR::J9 | 1 |
| supportsOnDemandLiteralPool() | OMR::OMR::Z | 0 |
| alwaysGeneratedSign(TR::Node *) | J9::J9::Z | 1 |
| codegenSupportsUnsignedIntegerDivide() | OMR::OMR::X86 | 0 |
| endInstructionSelection() | OMR::OMR::X86 | 1 |
